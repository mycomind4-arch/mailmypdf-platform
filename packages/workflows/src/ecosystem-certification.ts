...
export const ECOSYSTEM_CERTIFICATIONS: readonly EcosystemCertification[] = [
  ...
  },
  {
    ...
    blockedBy: ["production submission/tracking/proof certification", "deployed-path verification", "full runtime factory-to-mail integration"],
  ...
  },
  {
    ...
    blockedBy: ["deployed fulfillment certification", "remote CI verification", "full runtime entry-point verification"],
  ...
  },
  {
    ...
    blockedBy: ["real D1 provisioning", "live MailMyPDF credentials", "deployed integration test", "authenticated approval resolver", "production webhook registration"],
